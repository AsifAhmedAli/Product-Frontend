...
export default function Sidebar({ toggleSidebar, setToggleSidebar }) {
    return (
        <div className={`${styles.sidebar} fixed top-0 ${toggleSidebar ? `-left-full` : `left-0`} pb-14 border-r-2 sm:border-r-0 mb-4 sm:bg-transparent bg-blue-100`}>
            ...
            <div className="flex flex-wrap items-center justify-center">
                <div className="w-full">
                    <div className="transition-all hover:shadow-md w-1/2 block mx-auto text-blue-500 hover:text-blue-700 text-left py-2 font-bold mb-6 rounded-lg">
                        <Link href="/">
                            <div className="pl-4 sm:pl-2 cursor-pointer flex items-center">
                                <i className="fas fa-lightbulb pr-4 text-xl"></i>
                    ...
                    <div className="transition-all hover:shadow-md w-1/2 block mx-auto text-blue-500 hover:text-blue-700 text-left py-2 font-bold mb-6 rounded-lg">
                        <Link href="/">
                            <div className="pl-4 sm:pl-2 cursor-pointer flex items-center hover:text-blue-700">
                                <i className="fas fa-wallet pr-4 text-xl"></i>
                    ...
                    <div className="transition-all hover:shadow-md w-1/2 block mx-auto text-blue-500 hover:text-blue-700 text-left py-2 font-bold mb-6 rounded-lg">
                        <Link href="/">
                            <div className="pl-4 sm:pl-2 cursor-pointer flex items-center">
                                <i className="fas fa-shopping-basket pr-4 text-xl"></i>
                    ...
                    <div className="transition-all hover:shadow-md w-1/2 block mx-auto text-blue-500 hover:text-blue-700 text-left py-2 font-bold mb-6 rounded-lg">
                        <Link href="/">
                            <div className="pl-4 sm:pl-2 cursor-pointer flex items-center">
                                <i className="fas fa-comments pr-4 text-xl"></i>
                    ...
                    <div className="transition-all hover:shadow-md w-1/2 block mx-auto text-blue-500 hover:text-blue-700 text-left py-2 font-bold mb-6 rounded-lg">
                        <Link href="/">
                            <div className="pl-4 sm:pl-2 cursor-pointer flex items-center">
                                <i className="fas fa-user-friends pr-4 text-xl"></i>
