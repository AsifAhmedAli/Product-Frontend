...
export default function Welcome() {
    return (
        <div className={`${styles.welcome} flex items-center justify-center md:justify-between text-white sm:pr-6 sm:pl-8 px-4 rounded-tr-none sm:rounded-l-none lg:border-b-2 border-opacity-50 border-0 sm:rounded-br-none`}>
